...
public class MpgsService {
                                ...
                                return clientResponse.bodyToMono(Map.class)
                                        .flatMap(map -> {
                                            ...
                                            return Mono.error(new CustomException(Response.builder()
                                                    .errors(List.of("unsuccessful creating session from MasterCard"))
                                                    .message("FAILED")
    ...
    public Mono<MasterCardUpdateSessionResponse> updateSession(MasterCardUpdateSessionRequest request, String sessionId, String merchantId){
